...
stage('Show Contents of target') {
      ...
      steps {
        ...
        sh 'scp /home/slave1/workspace/ParcelServices_Feature2/target/simple-parcel-service-app-1.0-SNAPSHOT.jar root@172.31.46.40:/opt/apache-tomcat-8.5.98/webapps'
